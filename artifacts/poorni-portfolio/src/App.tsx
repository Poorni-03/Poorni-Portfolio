...
const certifications = [
  ...
  },
  {
    ...
    provider: "Infochord Technology Pvt. Ltd.",
  },
];
    ...
    <div className="portfolio-shell min-h-[100dvh]">
      ...
      <header className="topbar">
        <div className="section-wrap nav-inner">
          <a className="brand-mark" href="#top" data-testid="link-brand">
            ...
            <span className="mono text-[0.7rem] font-medium tracking-[0.12em]">
              POORNI T C
            </span>
          </a>
          ...
          <div className="hero-layout">
            <div className="reveal">
              ...
              <p className="hero-copy">
                Software developer with hands-on internship experience in
                full-stack development and QA, strong CS foundation, and a track
                record of building responsive web apps.
              </p>
            ...
            <aside
              className="hero-aside reveal reveal-delay-2"
              aria-label="Introduction note"
            >
              <p className="hero-aside-label">A developer&apos;s note / 001</p>
              <p>
                I like understanding how things work — then making sure they
                work well.
              </p>
        ...
        >
          <div className="section-wrap">
            <div className="section-intro">
              ...
              <div>
                <h2 className="display-title section-heading" id="about-title">
                  Curious by default.
                </h2>
                <p className="lead">
                  I&apos;m building my career at the intersection of making and
                  checking: writing useful software, asking better questions,
                  and noticing the details that make a product feel trustworthy.
                </p>
              </div>
            </div>
            ...
            <div className="about-grid">
              <article className="card about-story reveal">
                <p>
                  My hands-on work spans full-stack development and software
                  testing. That range helps me move comfortably from a database
                  schema or REST API to the interface a person actually uses.
                </p>
                <p>
                  I bring a strong Computer Science foundation, a practical
                  learning mindset, and an instinct to make complex things
                  clearer for the next person on the team.
                </p>
                <div className="about-quote">
                  “Build with intent. Test with empathy.”
                </div>
                <div className="language-row" aria-label="Languages">
                  <span className="language-chip">
                    English <small>Professional</small>
                  </span>
                  <span className="language-chip">
                    Tamil <small>Bilingual</small>
                  </span>
                  <span className="language-chip">
                    Sourashtra <small>Native</small>
                  </span>
                </div>
              </article>

              <article
                className="card education-card reveal reveal-delay-1"
        ...
        <section className="section" id="skills" aria-labelledby="skills-title">
          <div className="section-wrap">
            <div className="section-intro">
              ...
              <div>
                <h2 className="display-title section-heading" id="skills-title">
                  Many layers,
                  <br />
                  <em>one mindset.</em>
                </h2>
                <p className="lead">
                  Tools change. The fundamentals stay: understand the problem,
                  keep the system legible, and leave it better than you found
                  it.
                </p>
              </div>
            </div>
            <div className="skills-layout">
              <div>
                ...
                <p className="skills-note">
                  From component composition to secure server-side logic, I
                  enjoy the handoff between layers.
                </p>
              </div>
              <div className="skills-list">
                {skillGroups.map((group, index) => (
                  <article
                    ...
                    key={group.title}
                    data-testid={`group-skills-${index}`}
                  >
                    <h3>{group.title}</h3>
        ...
        >
          <div className="section-wrap">
            <div className="section-intro">
              ...
              <div>
                <h2
                  className="display-title section-heading"
                  id="projects-title"
                >
                  Problems worth
                  <br />
                ...
                <p className="lead">
                  A small selection of projects where product thinking meets
          ...
          <div className="section-wrap">
            <div className="section-intro">
              ...
              <div>
                ...
                <p className="lead">
                  Every role has added a different lens: how to build, how to
                  verify, and how to collaborate.
                </p>
              </div>
            </div>
          ...
          <div className="section-wrap">
            <div className="section-intro">
              ...
              <div>
                ...
                <p className="lead">
                  Curiosity has a calendar. These are a few of the places
          ...
          <div className="section-wrap contact-grid">
            <div>
              ...
              <div className="contact-details">
                <a
                  ...
                  href="mailto:poornitc2003@gmail.com"
                ...
                <a
                  className="contact-detail"
                  href="https://www.linkedin.com/in/poornitc"
                  target="_blank"
                  rel="noreferrer"
                ...
                <a
                  className="contact-detail"
                  href="https://github.com/poornitc"
                  target="_blank"
                  rel="noreferrer"
            ...
            >
              {submitted ? (
                ...
                >
                  <strong>
                    <Check size={16} aria-hidden="true" /> Message noted.
                  </strong>
                  Thanks for reaching out — this static form is ready to connect
                  with a real inbox when needed.
                </div>
              ) : (
                <>
      ...
      <footer className="footer">
        <div className="section-wrap footer-inner">
          ...
          <a href="#top" data-testid="link-back-to-top">
            Back to top ↑
          </a>
        </div>
      </footer>
